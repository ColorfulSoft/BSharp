...
namespace Mono.Cecil.Rocks {
	...
	public class DocCommentId {
		...
		{
			if (commentMember is MethodDefinition && type is GenericParameter)
			    return ((MethodDefinition)commentMember).GenericParameters.Any (i => i.Name == ((GenericParameter)type).Name);
